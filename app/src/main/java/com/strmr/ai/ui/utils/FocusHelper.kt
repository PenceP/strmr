...
@Composable
fun LocalCurrentRouteProvider(currentRoute: String, content: @Composable () -> Unit) {
...
private fun isNavigatingBack(previousRoute: String?, currentRoute: String): Boolean {
