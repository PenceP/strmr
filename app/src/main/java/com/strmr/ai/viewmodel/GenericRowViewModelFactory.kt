 ...
 */
class GenericRowViewModelFactory
    @Inject
    constructor(
 ...
 */
@Singleton
class GenericRowViewModelStore
    @Inject
    constructor(
 ...
 */
@Composable
fun rememberGenericRowViewModel(configuration: GenericRowConfiguration): GenericRowViewModel {
