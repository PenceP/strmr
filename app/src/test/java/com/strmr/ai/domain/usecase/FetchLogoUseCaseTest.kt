...
class FetchLogoUseCaseTest {
    ...
    @Test
    fun `fetchAndExtractLogo returns English logo when available`() = runTest {
        // Given
        val tmdbId = 123
        val expectedLogoPath = "/english_logo.png"
        val mockResponse = TmdbImagesResponse(
            backdrops = emptyList(),
            logos = listOf(
    ...
    @Test
    fun `fetchAndExtractLogo returns first available logo when no English logo`() = runTest {
        // Given
        val tmdbId = 123
    ...
    @Test
    fun `fetchAndExtractLogo returns null when no logos available`() = runTest {
        // Given
        val tmdbId = 123
        val mockResponse = TmdbImagesResponse(
            backdrops = emptyList(),
    ...
    @Test
    fun `fetchAndExtractLogo returns null when API throws exception`() = runTest {
        // Given
        val tmdbId = 123
    ...
    @Test
    fun `fetchAndExtractLogo calls correct API method for TV shows`() = runTest {
        // Given
        val tmdbId = 123
        val mockResponse = TmdbImagesResponse(
            backdrops = emptyList(),
