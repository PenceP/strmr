...
class GetTrendingMoviesUseCaseTest {
    ...
    @Test
    fun `getTrendingMoviesFlow returns flow from repository`() =
        runTest {
            // Given
    ...
    @Test
    fun `refreshTrendingMovies returns success result`() =
        runTest {
            // Given
    ...
    @Test
    fun `refreshTrendingMovies returns failure result`() =
        runTest {
            // Given
