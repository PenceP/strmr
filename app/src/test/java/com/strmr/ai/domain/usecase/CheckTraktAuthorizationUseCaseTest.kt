...
class CheckTraktAuthorizationUseCaseTest {
    ...
    @Test
    fun `invoke returns success with true when account is valid`() = runTest {
        // Given
    ...
    @Test
    fun `invoke returns success with false when account is invalid`() = runTest {
        // Given
    ...
    @Test
    fun `invoke calls repository with correct account type`() = runTest {
        // Given
        whenever(accountRepository.isAccountValid("trakt")).thenReturn(true)
