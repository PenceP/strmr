...
class TraktApiServiceIntegrationTest {
    ...
    @Test
    fun getTrendingMoviesReturnsExpectedData() = runTest {
        // Given
        val mockResponse = """
            [
                {
    ...
    @Test
    fun getTrendingTvShowsReturnsExpectedData() = runTest {
        // Given
        val mockResponse = """
            [
                {
    ...
    @Test
    fun getMovieDetailsReturnsExpectedData() = runTest {
        // Given
        val mockResponse = """
            {
    ...
    @Test
    fun apiTimeoutHandling() = runTest {
    ...
    @Test
    fun malformedJsonHandling() = runTest {
    ...
    @Test
    fun emptyResponseHandling() = runTest {
