...
class MovieDaoTest {
    ...
    @Test
    fun insertMultipleMoviesAndGetAll() = runTest {
        // Given
        val movies = listOf(
    ...
    @Test
    fun getTrendingMoviesReturnsCorrectOrder() = runTest {
        // Given
        val movies = listOf(
    ...
    @Test
    fun getPopularMoviesReturnsCorrectOrder() = runTest {
        // Given
        val movies = listOf(
    ...
    @Test
    fun updateMovieUpdatesExistingRecord() = runTest {
        // Given
    ...
    @Test
    fun deleteMovieRemovesRecord() = runTest {
        // Given
        val movie = createTestMovieEntity(1, "Test Movie")
        movieDao.insertMovie(movie)
    ...
    @Test
    fun searchMoviesFindsMatches() = runTest {
        // Given
        val movies = listOf(
    ...
    @Test
    fun getMoviesByGenreReturnsCorrectMovies() = runTest {
        // Given
        val movies = listOf(
    ...
    @Test
    fun getMoviesByYearRangeReturnsCorrectMovies() = runTest {
        // Given
        val movies = listOf(
    ...
    @Test
    fun insertMovieWithComplexDataPreservesAllFields() = runTest {
        // Given
        val complexMovie = createTestMovieEntity(1, "Complex Movie").copy(
            cast = listOf(
                Actor(
                    id = 1,
                    name = "Actor One",
