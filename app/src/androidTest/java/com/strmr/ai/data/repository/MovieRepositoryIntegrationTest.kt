...
class MovieRepositoryIntegrationTest {
    ...
    fun setup() {
        ...
        dataRepository = DataMovieRepository(
    ...
    @Test
    fun getTrendingMoviesIntegrationTest() = runTest {
    ...
    @Test
    fun getMovieDetailsIntegrationTest() = runTest {
        // Given - Insert test data with complex relationships
        val testMovie = createTestMovieEntity(123, "Complex Movie").copy(
    ...
    @Test
    fun dataLayerTodomainLayerMappingIntegrationTest() = runTest {
        // Given - Complex movie with all possible fields populated
        val complexMovie = createTestMovieEntity(999, "Full Feature Movie").copy(
            ...
            year = 2024,
            imdbId = "tt9999999",
            belongsToCollection = com.strmr.ai.data.BelongsToCollection(
                id = 1,
    ...
    @Test
    fun repositoryReturnsNullForNonExistentMovie() = runTest {
    ...
    @Test
    fun repositoryHandlesEmptyTrendingMovies() = runTest {
        // Given - No trending movies in database (all have null trendingOrder)
        val regularMovies = listOf(
    ...
    @Test
    fun repositoryPreservesOrderFromDatabase() = runTest {
